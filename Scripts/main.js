...
function timedCount()
{
    ...
    if(next_bg >= 15) {
        ...
        document.body.style.backgroundImage = "url(resources/images/bg" + num_bg + ".jpg)";
        preLoadbg = new Image();
        if(num_bg == 5) {
            preLoadbg.src = "resources/images/bg1.jpg";
        } else {
            preLoadbg.src = "resources/images/bg" + (num_bg + 1) + ".jpg";
        }
        next_bg = 0;
    } else {
        next_bg = next_bg + 1;
